...
jsonSource_reaCosechadaenCaaPaneleraHectareas_2.addFeatures(features_reaCosechadaenCaaPaneleraHectareas_2);var lyr_reaCosechadaenCaaPaneleraHectareas_2 = new ol.layer.Vector({
    ...
    <img src="styles/legend/reaCosechadaenCaaPaneleraHectareas_2_0.png" />  4 - 84 <br />\
    <img src="styles/legend/reaCosechadaenCaaPaneleraHectareas_2_1.png" />  84 - 188 <br />\
    <img src="styles/legend/reaCosechadaenCaaPaneleraHectareas_2_2.png" />  188 - 338 <br />\
    <img src="styles/legend/reaCosechadaenCaaPaneleraHectareas_2_3.png" />  338 - 1038 <br />\
    <img src="styles/legend/reaCosechadaenCaaPaneleraHectareas_2_4.png" />  1038 - 2828 <br />'
        });

lyr_OpenStreetMap_0.setVisible(true);lyr_Limite_Departamental_1.setVisible(true);lyr_reaCosechadaenCaaPaneleraHectareas_2.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_Limite_Departamental_1,lyr_reaCosechadaenCaaPaneleraHectareas_2];
...
lyr_reaCosechadaenCaaPaneleraHectareas_2.set('fieldAliases', {'DEPT': 'DEPT', 'MUNICIPIO': 'MUNICIPIO', 'CULTIVO_1': 'CULTIVO_1', 'AÑO': 'AÑO', 'A.SEM.(Ha)': 'A.SEM.(Ha)', 'A.COS.(Ha)': 'A.COS.(Ha)', 'PROD.(Ton)': 'PROD.(Ton)', 'REND.(Ton/': 'REND.(Ton/', });
...
lyr_reaCosechadaenCaaPaneleraHectareas_2.set('fieldImages', {'DEPT': 'TextEdit', 'MUNICIPIO': 'TextEdit', 'CULTIVO_1': 'TextEdit', 'AÑO': 'TextEdit', 'A.SEM.(Ha)': 'TextEdit', 'A.COS.(Ha)': 'TextEdit', 'PROD.(Ton)': 'TextEdit', 'REND.(Ton/': 'TextEdit', });
...
lyr_reaCosechadaenCaaPaneleraHectareas_2.set('fieldLabels', {'DEPT': 'inline label', 'MUNICIPIO': 'inline label', 'CULTIVO_1': 'inline label', 'AÑO': 'inline label', 'A.SEM.(Ha)': 'inline label', 'A.COS.(Ha)': 'inline label', 'PROD.(Ton)': 'inline label', 'REND.(Ton/': 'inline label', });
